...
bcg_image = 'pictures//background.png'
pipe_image = 'pictures//pipe.png'
...
if __name__ == "__main__":
    ...
    game_image['message'] = pygame.image.load('pictures//message.png').convert_alpha()
    game_image['base'] = pygame.image.load('pictures//base.png').convert_alpha()
    game_image['pipe'] = (pygame.transform.rotate(pygame.image.load(pipe_image).convert_alpha(), 180),pygame.image.load(pipe_image).convert_alpha())
